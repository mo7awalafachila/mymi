...
export default function SignupScreen({ onContinue, age, setAge }: SignupScreen3Props) {
  return (
    <div className="bg-[#eee0dd] relative size-full" data-name="signup screen 3">
      <div className="absolute flex flex-col font-['Jost:Medium',sans-serif] font-medium justify-center leading-[0] left-[196.5px] text-[20px] text-black text-center text-nowrap top-[265px] translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[1.2] whitespace-pre">Enter age:</p>
      </div>
      <KnobElevation onClick={onContinue} />
      <div className="absolute h-[40px] left-[74px] rounded-[29px] top-[343px] w-[245px]">
        <input
          type="number"
          value={age}
