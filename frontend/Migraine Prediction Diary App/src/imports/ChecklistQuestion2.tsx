...
function FiRrCross({ onClick }: { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className="absolute left-[79px] size-[24px] top-[496px] cursor-pointer"
...
function FiRrHome({ onClick }: { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className="absolute left-[79px] size-[24px] top-[638px] cursor-pointer hover:opacity-70 transition-opacity"
...
function XButton({ onClick }: { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className="absolute left-[66px] size-[50px] top-[483px] cursor-pointer"
    >
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50 50">
        <g id="Group 50">
          <circle cx="25" cy="25" fill="var(--fill-0, #EEE0DD)" id="Ellipse 5" r="24.5" stroke="var(--stroke-0, #9E9290)" />
...
interface ChecklistQuestion2Props {
  onNavigateToHome?: () => void;
  onNo?: () => void;
  onYes?: () => void;
}

export default function ChecklistQuestion2({ onNavigateToHome, onNo, onYes }: ChecklistQuestion2Props) {
  return (
