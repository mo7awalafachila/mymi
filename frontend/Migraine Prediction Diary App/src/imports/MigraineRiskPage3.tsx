import svgPaths from "./svg-ygopb5omqw";

function Frame1() {
  return (
    <div className="absolute bg-[#eee0dd] h-[346px] left-[43px] rounded-[18px] top-[143px] w-[307px]">
      <div className="h-[346px] overflow-clip relative rounded-[inherit] w-[307px]">
        <div className="absolute flex flex-col font-['Jost:Regular',sans-serif] font-normal h-[212px] justify-center leading-[0] left-[153.5px] text-[24px] text-black text-center top-[173px] translate-x-[-50%] translate-y-[-50%] w-[211px]">
          <p className="leading-[1.2]">Overstimulation can trigger migraines by overwhelming the brain with too much sensory input.</p>
        </div>
      </div>
...
function Group1() {
  return (
    <div className="absolute contents left-[43px] top-[143px]">
      <Frame1 />
    </div>
  );
}
...
function FiRsSignIn() {
  return <div className="absolute left-[56px] size-[24px] top-[626px]" data-name="fi-rs-sign-in" />;
}
...
function FiRrArrowLeft({ onClick }: { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className="absolute left-[56px] size-[24px] top-[632px] cursor-pointer hover:opacity-70 transition-opacity"
...
interface MigraineRiskPage3Props {
  onBack?: () => void;
}

export default function MigraineRiskPage3({ onBack }: MigraineRiskPage3Props) {
  return (
    <div className="bg-[#eee0dd] relative size-full" data-name="checklist">
      <Frame onBack={onBack} />
      <div className="absolute flex flex-col font-['Jost:Regular',sans-serif] font-normal justify-center leading-[0] left-[165px] text-[36px] text-black text-center text-nowrap top-[76.5px] translate-x-[-50%] translate-y-[-50%]">
